...
open class AndroidDialog: JavaObject {
    ...
    public convenience init(context: AndroidSDK.Content.Context, themeResId: Int) {
        var __locals = [jobject]()
...
public extension AndroidDialog {
    ...
    func findViewById(_ id: Int) -> AndroidSDK.View.View? {
...
internal extension AndroidDialog {
    ...
    struct DialogJNICache {
        ...
        static let classSignature = AndroidSDK.App.className(["Dialog"])

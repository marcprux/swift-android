...
public extension AndroidSDK.View.Inputmethod {
...
extension AndroidInputMethodManager: AndroidSDK.Content.Context.SystemService {
    
    public static var systemServiceName: AndroidSDK.Content.Context.SystemService.Name { return .inputMethodService }
}
...
internal extension AndroidInputMethodManager {
    ...
    struct JNIInputMethodManager {
        ...
        static let classSignature = AndroidSDK.View.Inputmethod.className(["InputMethodManager"])

...
open class AndroidViewGroupMarginLayoutParams: AndroidSDK.View.ViewGroup.LayoutParams {
...
internal extension AndroidViewGroupMarginLayoutParams {
    ...
    struct ViewGroupMarginLayoutParamsJNICache {
        ...
        static let classSignature = AndroidSDK.View.className(["ViewGroup$MarginLayoutParams"])

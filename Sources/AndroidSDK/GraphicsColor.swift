...
public extension AndroidSDK.Graphics {
...
public extension AndroidGraphicsColor {
    ...
    static func valueOf(color: Int) -> AndroidSDK.Graphics.Color {
        ...
        return AndroidSDK.Graphics.Color(javaObject: __return)
    }
...
internal extension AndroidGraphicsColor {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.Graphics.className(["Color"])

...
open class AndroidContext: JavaObject {
    ...
    public func registerReceiver(receiver: AndroidSDK.Content.BroadcastReceiver, filter: AndroidSDK.Content.IntentFilter) -> AndroidSDK.Content.Intent {
    ...
    public func unregisterReceiver(receiver: AndroidSDK.Content.BroadcastReceiver){
...
public extension AndroidContext {
    ...
    func systemService <T> (_ service: T.Type) -> T? where T: JavaObject, T: AndroidSDK.Content.Context.SystemService {
...
internal extension AndroidContext {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.Content.className(["Context"])

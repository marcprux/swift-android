...
public extension AndroidMenuItemForward {
    ...
    func setIcon(_ icon: AndroidSDK.Graphics.Drawable.Drawable?) -> AndroidMenuItemForward {
    ...
    func getIcon() -> AndroidSDK.Graphics.Drawable.Drawable? {
...
internal extension AndroidMenuItemForward {
    ...
    struct MenuItemJNICache {
        ...
        static let classSignature = AndroidSDK.View.className(["MenuItem"])

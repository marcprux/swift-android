...
public struct AndroidGravity: RawRepresentable, Equatable {
    ...
    public static let start = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.START)
    
    public static let end = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.END)
    
    public static let top = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.TOP)
    
    public static let bottom = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.BOTTOM)
    
    public static let center = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.CENTER)
    
    public static let centerVertical = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.CENTER_VERTICAL)
    
    public static let centerHorizontal = AndroidSDK.View.Gravity(rawValue: AndroidGravityConstants.CENTER_HORIZONTAL)
    
    public static let startCenterVertical = AndroidSDK.View.Gravity(rawValue: Int(AndroidGravityConstants.START|AndroidGravityConstants.CENTER_VERTICAL))
    
    public static let endCenterVertical = AndroidSDK.View.Gravity(rawValue: Int(AndroidGravityConstants.END|AndroidGravityConstants.CENTER_VERTICAL))
}
...
fileprivate extension AndroidGravityConstants {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.View.className(["Gravity"])

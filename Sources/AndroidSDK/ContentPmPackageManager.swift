...
public extension AndroidSDK.Content.PM {
    
    typealias PackageManager = AndroidPackageManager
}

public extension AndroidSDK.Content.PM.PackageManager {
...
public struct AndroidPackageManagerPermission: RawRepresentable {
    ...
    public static let granted = AndroidSDK.Content.PM.PackageManager.Permission(rawValue: AndroidPackageManager.PERMISSION_GRANTED)
    
    public static let denied = AndroidSDK.Content.PM.PackageManager.Permission(rawValue: AndroidPackageManager.PERMISSION_DENIED)
}
...
private extension AndroidPackageManager {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.Content.PM.className(["PackageManager"])

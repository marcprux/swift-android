...
open class SwiftSupportAppCompatActivity: AndroidContextWrapper {
    ...
    public static func bind( __env: UnsafeMutablePointer<JNIEnv?>, __this: jobject?) -> jlong? {
        ...
        let objectType = AndroidSDKMainApplication().runtimeConfiguration.appCompatActivity
    ...
    open func onCreate(savedInstanceState: AndroidSDK.OS.Bundle?) {
    ...
    open func onActivityResult(requestCode: Int, resultCode: Int, data: AndroidSDK.Content.Intent?) {
    ...
    public func startActivity(intent: AndroidSDK.Content.Intent){
    ...
    public func startActivityForResult(intent: AndroidSDK.Content.Intent, requestCode: Int) {
    ...
    public func startService(service: AndroidSDK.Content.Intent) -> JavaObject? {
    ...
    public func stopService(name: AndroidSDK.Content.Intent)-> Bool {
    ...
    @inline(__always)
    internal func getResources() -> AndroidSDK.Content.Res.Resources? {
        
        var __locals = [jobject]()
        
        var __args = [jvalue]( repeating: jvalue(), count: 2)
        
        var result: AndroidSDK.Content.Res.Resources?
        ...
        withJavaObject {
            ...
            result = __return != nil ? AndroidSDK.Content.Res.Resources(javaObject: __return) : nil
        }
    ...
    public func setContentView(layout: AndroidSDK.R.Layout) {
    ...
    public func setContentView(view: AndroidSDK.View.View) {
    ...
    public func findViewById(_ id: Int) -> AndroidSDK.View.View? {
    ...
    public func addContentView(_ view: AndroidSDK.View.View, params: JavaObject) {
...
public func SwiftSupportAppCompatActivity_onCreate( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let bundle = __savedInstanceState != nil ? AndroidSDK.OS.Bundle(javaObject: __savedInstanceState) : nil
...
public func SwiftSupportAppCompatActivity_onActivityResultNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let data = __data != nil ? AndroidSDK.Content.Intent(javaObject: __data) : nil

...
public extension AndroidSDK.OS {
...
public final class AndroidOsParcelUuid: JavaObject {
    ...
    public class func fromString( arg0: String ) -> AndroidSDK.OS.ParcelUuid? {
        ...
        return __return != nil ? AndroidSDK.OS.ParcelUuid( javaObject: __return ) : nil
    }
...
private extension AndroidSDK.OS.ParcelUuid {

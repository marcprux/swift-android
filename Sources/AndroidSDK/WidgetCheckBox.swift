...
public extension AndroidSDK.Widget.CheckBox {
    
    
}

internal extension AndroidSDK.Widget.CheckBox {
    
    /// JNI Cache
    struct JNICacheCheckBox {
        
        /// JNI Java class signature
        static let classSignature = AndroidSDK.Widget.className(["CheckBox"])

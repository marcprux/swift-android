...
public extension AndroidMenuForward {
    ...
    func add(titleRes: Int) -> AndroidSDK.View.MenuItemForward {
    ...
    func add(_ title: String?) -> AndroidSDK.View.MenuItemForward {
    ...
    func add(groupId: Int, itemId: Int, order: Int, titleRes: Int) -> AndroidSDK.View.MenuItemForward {
    ...
    func add(groupId: Int, itemId: Int, order: Int, title: String) -> AndroidSDK.View.MenuItemForward {
...
internal extension AndroidMenuForward {
    ...
    struct MenuJNICache {
        ...
        static let classSignature = AndroidSDK.View.className(["Menu"])

...
public extension AndroidSDK.Widget.RecyclerView {
...
open class AndroidWidgetRecyclerViewAdapter: JavaObject {
    ...
    open func onCreateViewHolder(parent: AndroidSDK.View.ViewGroup, viewType: Int?) -> AndroidSDK.Widget.RecyclerView.ViewHolder {
    ...
    open func onBindViewHolder(holder: AndroidSDK.Widget.RecyclerView.ViewHolder, position: Int) {
        
        fatalError("\(#function) must be implemented in subclass")
    }
    
    open func onBindViewHolder(holder: AndroidSDK.Widget.RecyclerView.ViewHolder, position: Int, payloads: [JavaObject]) {}
}
...
private func AndroidWidgetRecyclerViewAdapter_onCreateViewHolder( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let parent = AndroidSDK.View.ViewGroup(javaObject: __parent)
...
private func AndroidWidgetRecyclerViewAdapter_onBindViewHolder( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let holder = AndroidSDK.Widget.RecyclerView.ViewHolder

...
open class AndroidWidgetBaseAdapter: JavaObject {
    ...
    open func notifyDataSetChanged() {
        ...
        withJavaObject {
            ...
            JNIMethod.CallVoidMethod(object: $0,
                                     ...
                                     methodSig: "()V",
                                     methodCache: &AndroidSDK.Widget.BaseAdapter.JNICache.MethodID.notifyDataSetChanged,
                                     args: &__args,
                                     locals: &__locals)
        }
    }
    ...
    open func getView(position: Int, convertView: AndroidSDK.View.View?, parent: AndroidSDK.View.ViewGroup) -> AndroidSDK.View.View {
...
fileprivate extension AndroidSDK.Widget.BaseAdapter {
...
private func AndroidWidgetBaseAdapter_getView( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let convertView = __convertView != nil ? AndroidSDK.View.View(javaObject: __convertView) : nil
    
    let parentView = AndroidSDK.View.ViewGroup(javaObject: __parent)

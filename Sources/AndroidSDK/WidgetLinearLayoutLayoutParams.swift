...
open class AndroidLinearLayoutLayoutParams: AndroidSDK.View.ViewGroup.MarginLayoutParams {
    ...
    // Copy constructor.
    public convenience init(p: AndroidSDK.View.ViewGroup.LayoutParams){
...
internal extension AndroidLinearLayoutLayoutParams {
    ...
    struct LayoutParamsJNICache {
        ...
        static let classSignature = AndroidSDK.Widget.className(["LinearLayout$LayoutParams"])

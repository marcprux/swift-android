...
open class AndroidFrameLayoutLayoutParams: AndroidSDK.View.ViewGroup.MarginLayoutParams {
    ...
    // Copy constructor.
    public convenience init(source: AndroidSDK.Widget.FrameLayout.FLayoutParams){
    ...
    // Copy constructor.
    public convenience init(source: AndroidSDK.View.ViewGroup.MarginLayoutParams){
    ...
    // Copy constructor.
    public convenience init(source: AndroidSDK.View.ViewGroup.LayoutParams){
...
internal extension AndroidFrameLayoutLayoutParams {
    ...
    struct FLayoutParamsJNICache {
        ...
        static let classSignature = AndroidSDK.Widget.className(["FrameLayout$LayoutParams"])

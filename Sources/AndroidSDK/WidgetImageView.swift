...
open class AndroidImageView: AndroidView {
    ...
    public func bindNewJavaObject(context: AndroidSDK.Content.Context){
...
public extension AndroidSDK.Widget.ImageView {
...
internal extension AndroidSDK.Widget.ImageView {
    
    /// JNI Cache
    struct JNICacheImageView {
        
        /// JNI Java class signature
        static let classSignature = AndroidSDK.Widget.className(["ImageView"])

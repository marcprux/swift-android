...
open class AndroidContextWrapper: AndroidContext {
    ...
    public override func registerReceiver(receiver: AndroidSDK.Content.BroadcastReceiver, filter: AndroidSDK.Content.IntentFilter) -> AndroidSDK.Content.Intent {
    ...
    public override func unregisterReceiver(receiver: AndroidSDK.Content.BroadcastReceiver){
...
private extension AndroidContextWrapper {
    ...
    struct JNICacheContextWrapper {
        ...
        static let classSignature = AndroidSDK.Content.className(["ContextWrapper"])

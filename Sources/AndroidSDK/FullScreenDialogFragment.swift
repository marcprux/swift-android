...
public extension AndroidSDK.App {
...
open class AndroidFullScreenDialogFragment: JavaObject {
    ...
    open func onCreateView(inflater: AndroidSDK.View.LayoutInflater, container: AndroidSDK.View.ViewGroup?, savedInstanceState: AndroidSDK.OS.Bundle?) -> AndroidSDK.View.View {
    ...
    open func onViewCreated(view: AndroidSDK.View.View, savedInstanceState: AndroidSDK.OS.Bundle?) {
...
public func AndroidFullScreenDialogFragment_onCreateViewNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let inflater = AndroidSDK.View.LayoutInflater.init(javaObject: __inflater)
    let container = __container != nil ? AndroidSDK.View.ViewGroup.init(javaObject: __container) : nil
    let bundle = __savedInstanceState != nil ? AndroidSDK.OS.Bundle(javaObject: __savedInstanceState) : nil
...
public func AndroidFullScreenDialogFragment_onViewCreatedNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let view = AndroidSDK.View.View(javaObject: __view)
    let bundle = __savedInstanceState != nil ? AndroidSDK.OS.Bundle(javaObject: __savedInstanceState) : nil

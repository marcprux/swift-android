...
open class AndroidViewGroup: AndroidView {
    ...
    func bindNewObject(context: AndroidSDK.Content.Context){
    ...
    open override func dispatchUnhandledMove(focused: AndroidSDK.View.View, direction: Int) -> Bool {
    ...
    open func addView(_ child: AndroidSDK.View.View, index: Int)  {
    ...
    open func addView(_ child: AndroidSDK.View.View, index: Int, params: AndroidSDK.View.ViewGroup.LayoutParams)  {
    ...
    open func addView(_ child: AndroidSDK.View.View)  {
    ...
    open func addView(_ child: AndroidSDK.View.View, params: AndroidSDK.View.ViewGroup.LayoutParams)  {
    ...
    open func addView(child: AndroidSDK.View.View, width: Int, height: Int)  {
...
public extension AndroidSDK.View.ViewGroup {
    ...
    func bringChildToFront(child: AndroidSDK.View.View)  {
    ...
    func childDrawableStateChanged(child: AndroidSDK.View.View)  {
    ...
    func childHasTransientStateChanged(child: AndroidSDK.View.View, childHasTransientState: Bool)  {
    ...
    func clearChildFocus(child: AndroidSDK.View.View)  {
    ...
    func endViewTransition(view: AndroidSDK.View.View)  {
    ...
    func findFocus() -> AndroidSDK.View.View {
    ...
    func focusSearch(focused: AndroidSDK.View.View, direction: Int) -> AndroidSDK.View.View {
    ...
    func focusableViewAvailable(v: AndroidSDK.View.View)  {
    ...
    func getChildAt(index: Int) -> AndroidSDK.View.View {
     ...
     */
    func measureChild(child: AndroidSDK.View.View, parentWidthMeasureSpec: Int, parentHeightMeasureSpec: Int)  {
    ...
    func getFocusedChild() -> AndroidSDK.View.View {
    ...
    func indexOfChild(child: AndroidSDK.View.View) -> Int {
    ...
    func invalidateChild(child: AndroidSDK.View.View, dirty: JavaObject)  {
    ...
    func notifySubtreeAccessibilityStateChanged(child: AndroidSDK.View.View, source: AndroidSDK.View.View, changeType: Int)  {
    ...
    func offsetDescendantRectToMyCoords(descendant: AndroidSDK.View.View, rect: JavaObject)  {
    ...
    func offsetRectIntoDescendantCoords(descendant: AndroidSDK.View.View, rect: JavaObject)  {
    ...
    func onDescendantInvalidated(child: AndroidSDK.View.View, target: AndroidSDK.View.View)  {
    ...
    func onNestedFling(target: AndroidSDK.View.View, velocityX: Float, velocityY: Float, consumed: Bool) -> Bool {
    ...
    func onNestedPreFling(target: AndroidSDK.View.View, velocityX: Float, velocityY: Float) -> Bool {
    ...
    func onNestedPreScroll(target: AndroidSDK.View.View, dx: Int, dy: Int, consumed: [Int])  {
    ...
    func onNestedScroll(target: AndroidSDK.View.View, dxConsumed: Int, dyConsumed: Int, dxUnconsumed: Int, dyUnconsumed: Int)  {
    ...
    func onNestedScrollAccepted(child: AndroidSDK.View.View, target: AndroidSDK.View.View, axes: Int)  {
    ...
    func onStartNestedScroll(child: AndroidSDK.View.View, target: AndroidSDK.View.View, nestedScrollAxes: Int) -> Bool {
    ...
    func onStopNestedScroll(child: AndroidSDK.View.View)  {
    ...
    func onViewAdded(child: AndroidSDK.View.View)  {
    ...
    func onViewRemoved(child: AndroidSDK.View.View)  {
    ...
    func recomputeViewAttributes(child: AndroidSDK.View.View)  {
    ...
    func removeView(view: AndroidSDK.View.View)  {
    ...
    func removeViewInLayout(view: AndroidSDK.View.View)  {
    ...
    func requestChildFocus(child: AndroidSDK.View.View, focused: AndroidSDK.View.View)  {
    ...
    func requestChildRectangleOnScreen(child: AndroidSDK.View.View, rectangle: JavaObject, immediate: Bool) -> Bool {
    ...
    func requestTransparentRegion(child: AndroidSDK.View.View)  {
    ...
    func showContextMenuForChild(originalView: AndroidSDK.View.View, x: Float, y: Float) -> Bool {
    ...
    func showContextMenuForChild(originalView: AndroidSDK.View.View) -> Bool {
    ...
    func startViewTransition(view: AndroidSDK.View.View)  {
...
internal extension AndroidSDK.View.ViewGroup {

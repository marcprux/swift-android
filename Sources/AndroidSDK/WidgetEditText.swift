...
public extension AndroidSDK.Widget.EditText {
...
internal extension AndroidSDK.Widget.EditText {
    
    /// JNI Cache
    struct JNICacheEditText {
        
        /// JNI Java class signature
        static let classSignature = AndroidSDK.Widget.className(["EditText"])

...
public struct AndroidBuildSdk: RawRepresentable, Equatable {
    ...
    public static let sdkInt = AndroidSDK.OS.Build.Version.Sdk(rawValue: AndroidBuildVersionConstants.SDK_INT)
    
    /// The developer preview revision of a prerelease SDK. This value will always be 0 on production platform builds/devices.
    public static let previewSdkInt = AndroidSDK.OS.Build.Version.Sdk(rawValue: AndroidBuildVersionConstants.PREVIEW_SDK_INT)
}
...
public struct AndroidBuildVersion: RawRepresentable, Equatable {
    ...
    public static let baseOS = AndroidSDK.OS.Build.Version(rawValue: AndroidBuildVersionConstants.BASE_OS)
    
    /// The current development codename, or the string "REL" if this is a release build.
    public static let codename = AndroidSDK.OS.Build.Version(rawValue: AndroidBuildVersionConstants.CODENAME)
    ...
    public static let incremental = AndroidSDK.OS.Build.Version(rawValue: AndroidBuildVersionConstants.INCREMENTAL)
    
    /// The user-visible version string. E.g., "1.0" or "3.4b5".
    public static let release = AndroidSDK.OS.Build.Version(rawValue: AndroidBuildVersionConstants.RELEASE)
    
    /// The user-visible security patch level.
    public static let securityPatch = AndroidSDK.OS.Build.Version(rawValue: AndroidBuildVersionConstants.SECURITY_PATCH)
}

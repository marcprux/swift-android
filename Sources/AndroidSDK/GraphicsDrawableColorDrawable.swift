...
public extension AndroidSDK.Graphics.Drawable {
    
    typealias ColorDrawable = AndroidGraphicsDrawableColorDrawable
}

public class AndroidGraphicsDrawableColorDrawable: AndroidSDK.Graphics.Drawable.Drawable {
...
public extension AndroidGraphicsDrawableColorDrawable {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.Graphics.Drawable.className(["ColorDrawable"])

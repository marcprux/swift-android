...
open class AndroidView: JavaObject {
    ...
    public var layoutParams: AndroidSDK.View.ViewGroup.LayoutParams? {
    ...
    public var context: AndroidSDK.Content.Context? {
    ...
    public var background: AndroidSDK.Graphics.Drawable.Drawable? {
        get {
    ...
    public var parent: AndroidSDK.Widget.FrameLayout? {
        get {
            return getParent()
        }
    }
    
    open func findViewById(_ id: Int) -> AndroidSDK.View.View? {
        ...
        return __return != nil ? AndroidSDK.View.View(javaObject: __return) : nil
    }
    
    open func findViewWithTag(_ tag: JavaObject) -> AndroidSDK.View.View? {
    ...
    open func dispatchUnhandledMove(focused: AndroidSDK.View.View, direction: Int) -> Bool {
...
public extension AndroidSDK.View.View {
...
public extension AndroidSDK.View.View {
    ...
    @inline(__always)
    internal func setBackground(_ background: AndroidSDK.Graphics.Drawable.Drawable?)  {
    ...
    @inline(__always)
    internal func getBackground() -> AndroidSDK.Graphics.Drawable.Drawable? {
        ...
        return __return != nil ? AndroidSDK.Graphics.Drawable.Drawable(javaObject: __return) : nil
    }
    
    @inline(__always)
    func findViewById(_ id: AndroidSDK.R.ID) -> AndroidSDK.View.View? {
    ...
    @inline(__always)
    internal func getContext() -> AndroidSDK.Content.Context? {
        ...
        return __return != nil ? AndroidSDK.Content.Context(javaObject: __return) : nil
    }
    ...
    var visibility: AndroidSDK.View.View.Visibility {
        
        get { return AndroidSDK.View.View.Visibility(rawValue: getVisibility()) }
    ...
    var windowVisibility: AndroidSDK.View.View.Visibility {
        return AndroidSDK.View.View.Visibility(rawValue: getWindowVisibility())
    }
    ...
    func setOnClickListener(_ block: @escaping () -> ()) {
        ...
        let onClickListener = AndroidSDK.View.View.OnClickListener(block: block)
        
        setOnClickListener(onClickListener)
    }
    
    func setOnClickListener(_ l: AndroidSDK.View.View.OnClickListener?) {
        var __locals = [jobject]()
    ...
    func checkInputConnectionProxy(view: AndroidSDK.View.View) -> Bool {
    ...
    @inline(__always)
    internal func getLayoutParams() -> AndroidSDK.View.ViewGroup.LayoutParams? {
        ...
        return AndroidSDK.View.ViewGroup.LayoutParams.init(javaObject: __return)
    }
    
    @inline(__always)
    internal func setLayoutParams(_ layoutParams: AndroidSDK.View.ViewGroup.LayoutParams?) {
    ...
    @inline(__always)
    internal func getParent() -> AndroidSDK.Widget.FrameLayout? {
        ...
        return __return != nil ? AndroidSDK.Widget.FrameLayout(casting: JavaObject(javaObject: __return)) : nil
    }
    
    @inline(__always)
    internal func getRootView() -> AndroidSDK.View.View? {
...
internal extension AndroidSDK.View.View {
    
    /// JNI Cache
    enum JNICache {
        
        /// JNI Java class signature
        static let classSignature = AndroidSDK.View.className(["View"])
...
public extension AndroidSDK.View.View.Visibility {
    
    static let visible = AndroidSDK.View.View.Visibility(rawValue: AndroidSDK.View.View.VISIBLE)
    
    static let invisible = AndroidSDK.View.View.Visibility(rawValue: AndroidSDK.View.View.INVISIBLE)
    
    static let gone = AndroidSDK.View.View.Visibility(rawValue: AndroidSDK.View.View.GONE)
}

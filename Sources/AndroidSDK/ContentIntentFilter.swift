...
public final class AndroidIntentFilter: JavaObject {
    ...
    public convenience init(o: AndroidSDK.Content.IntentFilter){
        var __locals = [jobject]()
...
public extension AndroidSDK.Content.IntentFilter {
...
internal extension AndroidSDK.Content.IntentFilter {
    // JNI Cache
    struct JNICache {
        
        static let classSignature = AndroidSDK.Content.className(["IntentFilter"])

...
open class AndroidBroadcastReceiver: JavaObject {
    ...
    open func onReceive(context: AndroidSDK.Content.Context?, intent: AndroidSDK.Content.Intent?){
...
private func AndroidBroadcastReceiver_onReceive( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let context = __context != nil ? AndroidSDK.Content.Context(javaObject: __context) : nil
    let intent = __intent != nil ? AndroidSDK.Content.Intent(javaObject: __intent) : nil

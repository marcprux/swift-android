...
public struct AndroidManifestPermissionGroup {
    ...
    public static let calendar = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CALENDAR)
    
    public static let callLog = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CALL_LOG)
    
    public static let camera = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CAMERA)
    
    public static let contacts = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CONTACTS)
    
    public static let location = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.LOCATION)
    
    public static let microphone = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.MICROPHONE)
    
    public static let phone = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.PHONE)
    
    public static let sensors = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.SENSORS)
    
    public static let sms = AndroidSDK.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.SMS)
    
    public static let storage = AndroidSDK.ManifestPermissionGroup(rawValue:

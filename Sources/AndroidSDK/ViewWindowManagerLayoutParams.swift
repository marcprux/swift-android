...
open class AndroidWindowManagerLayoutParams: AndroidSDK.View.ViewGroup.LayoutParams {
...
internal extension AndroidWindowManagerLayoutParams {
    ...
    struct JNICacheWindowManagerLayoutParams {
        ...
        static let classSignature = AndroidSDK.View.className(["WindowManager$LayoutParams"])

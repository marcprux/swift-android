...
open class AndroidTabLayout: AndroidHorizontalScrollView {
    ...
    public override func bindNewJavaObject(context: AndroidSDK.Content.Context){
    ...
    override open func addView(_ child: AndroidSDK.View.View, index: Int)  {
    ...
    override open func addView(_ child: AndroidSDK.View.View, index: Int, params: AndroidSDK.View.ViewGroup.LayoutParams)  {
    ...
    override open func addView(_ child: AndroidSDK.View.View, params: AndroidSDK.View.ViewGroup.LayoutParams)  {

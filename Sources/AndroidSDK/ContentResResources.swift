...
public extension AndroidSDK.Content.Res {
...
public extension AndroidContentResResources {
    ...
    func getDisplayMetrics() -> AndroidSDK.Util.DisplayMetrics? {
        ...
        return __return != nil ? AndroidSDK.Util.DisplayMetrics(javaObject: __return) : nil
    }
...
internal extension AndroidContentResResources {
    ...
    struct JNICache {
        ...
        static let classSignature = AndroidSDK.Content.Res.className(["Resources"])

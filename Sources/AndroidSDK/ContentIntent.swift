...
public extension AndroidSDK.Content {
...
public final class AndroidIntent: JavaObject {
    ...
    public convenience init(o: AndroidSDK.Content.Intent){
        var __locals = [jobject]()
...
public extension AndroidSDK.Content.Intent {
...
public extension AndroidSDK.Content.Intent {
     ...
     */
    @discardableResult
    func putExtra(name: String, value: [Int64]) -> AndroidSDK.Content.Intent {
        ...
        return AndroidSDK.Content.Intent(javaObject: __return)
    }
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Int8) -> AndroidSDK.Content.Intent {
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Int) -> AndroidSDK.Content.Intent {
        var __locals = [jobject]()
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Double) -> AndroidSDK.Content.Intent {
        var __locals = [jobject]()
     ...
     */
    @discardableResult
    func putExtra(name: String, value: String) -> AndroidSDK.Content.Intent {
    ...
    @discardableResult
    func setType(_ type: String) -> AndroidSDK.Content.Intent {
...
private extension AndroidSDK.Content.Intent {
    // JNI Cache
    struct JNICache {
        
        static let classSignature = AndroidSDK.Content.className(["Intent"])

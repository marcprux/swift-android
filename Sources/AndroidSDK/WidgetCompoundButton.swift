...
public extension AndroidSDK.Widget.CompoundButton {
...
internal extension AndroidSDK.Widget.CompoundButton {
    
    /// JNI Cache
    struct JNICacheCompoundButton {
        
        /// JNI Java class signature
        static let classSignature = AndroidSDK.Widget.className(["CompoundButton"])

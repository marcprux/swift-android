...
public final class AndroidToolbar: AndroidViewGroup {
    ...
    public var navigationIcon: AndroidSDK.Graphics.Drawable.Drawable? {
        
        get { return getNavigationIcon() }
        set { setNavigationIcon(newValue) }
    }
    
    public var logo: AndroidSDK.Graphics.Drawable.Drawable? {
...
public extension AndroidToolbar {
    ...
    @inline(__always)
    internal func setNavigationIcon(_ icon: AndroidSDK.Graphics.Drawable.Drawable?)  {
    ...
    @inline(__always)
    internal func getNavigationIcon() -> AndroidSDK.Graphics.Drawable.Drawable? {
    ...
    @inline(__always)
    internal func setLogo(_ icon: AndroidSDK.Graphics.Drawable.Drawable?)  {
    ...
    @inline(__always)
    internal func getLogo() -> AndroidSDK.Graphics.Drawable.Drawable? {
    ...
    func setOnMenuItemClickListener(_ block: @escaping (AndroidMenuItemForward?) -> (Bool)) {
        ...
        let onMenuItemClickListener = AndroidSDK.Widget.Toolbar.OnMenuItemClickListener(block: block)
        
        setOnMenuItemClickListener(onMenuItemClickListener)
    }
    
    private func setOnMenuItemClickListener(_ listener: AndroidSDK.Widget.Toolbar.OnMenuItemClickListener) {
    ...
    @inline(__always)
    internal func getMenu() -> AndroidSDK.View.MenuForward {
        ...
        return AndroidSDK.View.MenuForward(javaObject: __return)
    }

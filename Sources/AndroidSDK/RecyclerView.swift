...
public final class AndroidWidgetRecyclerView: AndroidViewGroup {
    ...
    public var layoutManager: AndroidSDK.Widget.RecyclerView.LayoutManager {
...
public extension AndroidWidgetRecyclerView {
    ...
    internal func getAdapter() -> AndroidWidgetRecyclerViewAdapter {
        ...
        return AndroidSDK.Widget.RecyclerView.Adapter(javaObject: __return)
    }
    ...
    @usableFromInline
    internal func getLayoutManager() -> AndroidSDK.Widget.RecyclerView.LayoutManager {
        ...
        return AndroidSDK.Widget.RecyclerView.LayoutManager(javaObject: __return)
    }
    
    @usableFromInline
    internal func setLayoutManager(_ layoutManager: AndroidSDK.Widget.RecyclerView.LayoutManager) {
    ...
    func addItemDecoration(_ decor: AndroidSDK.Widget.RecyclerView.ItemDecoration) {
    ...
    func addItemDecoration(_ decor: AndroidSDK.Widget.RecyclerView.ItemDecoration, index: Int) {
    ...
    func removeItemDecoration(_ decor: AndroidSDK.Widget.RecyclerView.ItemDecoration) {

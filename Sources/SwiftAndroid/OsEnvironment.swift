...
public extension SwiftAndroid.OS.Environment {
...
internal extension SwiftAndroid.OS.Environment {
    
    /// JNI Cache
    struct JNICache {
        
        /// JNI Java class signature
        static let classSignature = SwiftAndroid.OS.className(["Environment"])

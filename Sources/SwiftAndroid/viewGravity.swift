...
public struct AndroidGravity: RawRepresentable, Equatable {
    ...
    public static let start = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.START)
    
    public static let end = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.END)
    
    public static let top = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.TOP)
    
    public static let bottom = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.BOTTOM)
    
    public static let center = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.CENTER)
    
    public static let centerVertical = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.CENTER_VERTICAL)
    
    public static let centerHorizontal = SwiftAndroid.View.Gravity(rawValue: AndroidGravityConstants.CENTER_HORIZONTAL)
    
    public static let startCenterVertical = SwiftAndroid.View.Gravity(rawValue: Int(AndroidGravityConstants.START|AndroidGravityConstants.CENTER_VERTICAL))
    
    public static let endCenterVertical = SwiftAndroid.View.Gravity(rawValue: Int(AndroidGravityConstants.END|AndroidGravityConstants.CENTER_VERTICAL))
}
...
fileprivate extension AndroidGravityConstants {
    ...
    struct JNICache {
        ...
        static let classSignature = SwiftAndroid.View.className(["Gravity"])

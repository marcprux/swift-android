...
public extension SwiftAndroid.Content.PM {
    
    typealias PackageManager = AndroidPackageManager
}

public extension SwiftAndroid.Content.PM.PackageManager {
...
public struct AndroidPackageManagerPermission: RawRepresentable {
    ...
    public static let granted = SwiftAndroid.Content.PM.PackageManager.Permission(rawValue: AndroidPackageManager.PERMISSION_GRANTED)
    
    public static let denied = SwiftAndroid.Content.PM.PackageManager.Permission(rawValue: AndroidPackageManager.PERMISSION_DENIED)
}
...
private extension AndroidPackageManager {
    ...
    struct JNICache {
        ...
        static let classSignature = SwiftAndroid.Content.PM.className(["PackageManager"])

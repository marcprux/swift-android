...
public extension SwiftAndroid.View.Inputmethod {
...
extension AndroidInputMethodManager: SwiftAndroid.Content.Context.SystemService {
    
    public static var systemServiceName: SwiftAndroid.Content.Context.SystemService.Name { return .inputMethodService }
}
...
internal extension AndroidInputMethodManager {
    ...
    struct JNIInputMethodManager {
        ...
        static let classSignature = SwiftAndroid.View.Inputmethod.className(["InputMethodManager"])

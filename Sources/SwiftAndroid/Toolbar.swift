...
public final class AndroidToolbar: AndroidViewGroup {
    ...
    public var navigationIcon: SwiftAndroid.Graphics.Drawable.Drawable? {
        
        get { return getNavigationIcon() }
        set { setNavigationIcon(newValue) }
    }
    
    public var logo: SwiftAndroid.Graphics.Drawable.Drawable? {
...
public extension AndroidToolbar {
    ...
    @inline(__always)
    internal func setNavigationIcon(_ icon: SwiftAndroid.Graphics.Drawable.Drawable?)  {
    ...
    @inline(__always)
    internal func getNavigationIcon() -> SwiftAndroid.Graphics.Drawable.Drawable? {
    ...
    @inline(__always)
    internal func setLogo(_ icon: SwiftAndroid.Graphics.Drawable.Drawable?)  {
    ...
    @inline(__always)
    internal func getLogo() -> SwiftAndroid.Graphics.Drawable.Drawable? {
    ...
    func setOnMenuItemClickListener(_ block: @escaping (AndroidMenuItemForward?) -> (Bool)) {
        ...
        let onMenuItemClickListener = SwiftAndroid.Widget.Toolbar.OnMenuItemClickListener(block: block)
        
        setOnMenuItemClickListener(onMenuItemClickListener)
    }
    
    private func setOnMenuItemClickListener(_ listener: SwiftAndroid.Widget.Toolbar.OnMenuItemClickListener) {
    ...
    @inline(__always)
    internal func getMenu() -> SwiftAndroid.View.MenuForward {
        ...
        return SwiftAndroid.View.MenuForward(javaObject: __return)
    }

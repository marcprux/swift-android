...
public final class AndroidWidgetRecyclerView: AndroidViewGroup {
    ...
    public var layoutManager: SwiftAndroid.Widget.RecyclerView.LayoutManager {
...
public extension AndroidWidgetRecyclerView {
    ...
    internal func getAdapter() -> AndroidWidgetRecyclerViewAdapter {
        ...
        return SwiftAndroid.Widget.RecyclerView.Adapter(javaObject: __return)
    }
    ...
    @usableFromInline
    internal func getLayoutManager() -> SwiftAndroid.Widget.RecyclerView.LayoutManager {
        ...
        return SwiftAndroid.Widget.RecyclerView.LayoutManager(javaObject: __return)
    }
    
    @usableFromInline
    internal func setLayoutManager(_ layoutManager: SwiftAndroid.Widget.RecyclerView.LayoutManager) {
    ...
    func addItemDecoration(_ decor: SwiftAndroid.Widget.RecyclerView.ItemDecoration) {
    ...
    func addItemDecoration(_ decor: SwiftAndroid.Widget.RecyclerView.ItemDecoration, index: Int) {
    ...
    func removeItemDecoration(_ decor: SwiftAndroid.Widget.RecyclerView.ItemDecoration) {

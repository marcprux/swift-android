...
public extension SwiftAndroid.Widget.EditText {
...
internal extension SwiftAndroid.Widget.EditText {
    
    /// JNI Cache
    struct JNICacheEditText {
        
        /// JNI Java class signature
        static let classSignature = SwiftAndroid.Widget.className(["EditText"])

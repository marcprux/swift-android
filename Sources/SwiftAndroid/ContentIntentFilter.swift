...
public final class AndroidIntentFilter: JavaObject {
    ...
    public convenience init(o: SwiftAndroid.Content.IntentFilter){
        var __locals = [jobject]()
...
public extension SwiftAndroid.Content.IntentFilter {
...
internal extension SwiftAndroid.Content.IntentFilter {
    // JNI Cache
    struct JNICache {
        
        static let classSignature = SwiftAndroid.Content.className(["IntentFilter"])

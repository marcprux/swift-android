...
public extension SwiftAndroid.Widget.RecyclerView {
...
open class AndroidWidgetRecyclerViewAdapter: JavaObject {
    ...
    open func onCreateViewHolder(parent: SwiftAndroid.View.ViewGroup, viewType: Int?) -> SwiftAndroid.Widget.RecyclerView.ViewHolder {
    ...
    open func onBindViewHolder(holder: SwiftAndroid.Widget.RecyclerView.ViewHolder, position: Int) {
        
        fatalError("\(#function) must be implemented in subclass")
    }
    
    open func onBindViewHolder(holder: SwiftAndroid.Widget.RecyclerView.ViewHolder, position: Int, payloads: [JavaObject]) {}
}
...
private func AndroidWidgetRecyclerViewAdapter_onCreateViewHolder( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let parent = SwiftAndroid.View.ViewGroup(javaObject: __parent)
...
private func AndroidWidgetRecyclerViewAdapter_onBindViewHolder( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let holder = SwiftAndroid.Widget.RecyclerView.ViewHolder

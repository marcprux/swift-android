...
public extension SwiftAndroid.Graphics {
...
public extension AndroidGraphicsColor {
    ...
    static func valueOf(color: Int) -> SwiftAndroid.Graphics.Color {
        ...
        return SwiftAndroid.Graphics.Color(javaObject: __return)
    }
...
internal extension AndroidGraphicsColor {
    ...
    struct JNICache {
        ...
        static let classSignature = SwiftAndroid.Graphics.className(["Color"])

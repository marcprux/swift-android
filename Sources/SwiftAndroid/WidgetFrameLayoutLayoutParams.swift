...
open class AndroidFrameLayoutLayoutParams: SwiftAndroid.View.ViewGroup.MarginLayoutParams {
    ...
    // Copy constructor.
    public convenience init(source: SwiftAndroid.Widget.FrameLayout.FLayoutParams){
    ...
    // Copy constructor.
    public convenience init(source: SwiftAndroid.View.ViewGroup.MarginLayoutParams){
    ...
    // Copy constructor.
    public convenience init(source: SwiftAndroid.View.ViewGroup.LayoutParams){
    ...
    public convenience init(context: SwiftAndroid.Content.Context, attrs: JavaObject){
...
internal extension AndroidFrameLayoutLayoutParams {
    ...
    struct FLayoutParamsJNICache {
        ...
        static let classSignature = SwiftAndroid.Widget.className(["FrameLayout$LayoutParams"])

...
open class AndroidProgressBar: AndroidView {
    ...
    public convenience init(context: SwiftAndroid.Content.Context, attrs: JavaObject, defStyleAttr: Int) {
        var __locals = [jobject]()
    ...
    public convenience init(context: SwiftAndroid.Content.Context, attrs: JavaObject, defStyleAttr: Int, defStyleRes: Int) {
        var __locals = [jobject]()
...
internal extension AndroidProgressBar {
    ...
    struct JNICacheProgressBar {
        ...
        static let classSignature = SwiftAndroid.Widget.className(["ProgressBar"])

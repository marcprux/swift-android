...
public extension AndroidMenuItemForward {
    ...
    func setIcon(_ icon: SwiftAndroid.Graphics.Drawable.Drawable?) -> AndroidMenuItemForward {
    ...
    func getIcon() -> SwiftAndroid.Graphics.Drawable.Drawable? {
...
internal extension AndroidMenuItemForward {
    ...
    struct MenuItemJNICache {
        ...
        static let classSignature = SwiftAndroid.View.className(["MenuItem"])

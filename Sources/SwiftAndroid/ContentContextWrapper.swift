...
open class AndroidContextWrapper: AndroidContext {
    ...
    public override func registerReceiver(receiver: SwiftAndroid.Content.BroadcastReceiver, filter: SwiftAndroid.Content.IntentFilter) -> SwiftAndroid.Content.Intent {
    ...
    public override func unregisterReceiver(receiver: SwiftAndroid.Content.BroadcastReceiver){
...
private extension AndroidContextWrapper {
    ...
    struct JNICacheContextWrapper {
        ...
        static let classSignature = SwiftAndroid.Content.className(["ContextWrapper"])

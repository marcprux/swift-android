...
open class AndroidDialog: JavaObject {
    ...
    public convenience init(context: SwiftAndroid.Content.Context, themeResId: Int) {
        var __locals = [jobject]()
...
public extension AndroidDialog {
    ...
    func findViewById(_ id: Int) -> SwiftAndroid.View.View? {
...
internal extension AndroidDialog {
    ...
    struct DialogJNICache {
        ...
        static let classSignature = SwiftAndroid.App.className(["Dialog"])

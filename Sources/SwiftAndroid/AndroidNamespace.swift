...
/// Android namespace.
public enum SwiftAndroid: JavaPackage {

    public static let package: JNIPackage = ["android"]
    
    public enum Util: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["util"]
    }
    
    public enum OS: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["os"]
    }
    
    public enum Content: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["content"]
        
        public enum PM: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.Content.package + ["pm"]
        }
        
        public enum Res: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.Content.package + ["res"]
        }
    }
    
    public enum Widget: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["widget"]
    }
    
    public enum View: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["view"]
        
        public enum Inputmethod: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.View.package + ["inputmethod"]
        }
        
        public enum Animation: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.View.package + ["animation"]
        }
    }
    
    public enum App: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["app"]
    }
    
    public enum Bluetooth: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["bluetooth"]
        
        public enum LE: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.Bluetooth.package + ["le"]
        }
    }
    
    public enum Graphics: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["graphics"]
        
        public enum Drawable: JavaPackage {
            
            public static let package: JNIPackage = SwiftAndroid.Graphics.package + ["drawable"]
        }
    }
    
    public enum Text: JavaPackage {
        
        public static let package: JNIPackage = SwiftAndroid.package + ["text"]
    }
}

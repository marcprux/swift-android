...
open class AndroidBroadcastReceiver: JavaObject {
    ...
    open func onReceive(context: SwiftAndroid.Content.Context?, intent: SwiftAndroid.Content.Intent?){
...
private func AndroidBroadcastReceiver_onReceive( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let context = __context != nil ? SwiftAndroid.Content.Context(javaObject: __context) : nil
    let intent = __intent != nil ? SwiftAndroid.Content.Intent(javaObject: __intent) : nil

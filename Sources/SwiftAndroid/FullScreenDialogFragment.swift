...
public extension SwiftAndroid.App {
...
open class AndroidFullScreenDialogFragment: JavaObject {
    ...
    open func onCreateView(inflater: SwiftAndroid.View.LayoutInflater, container: SwiftAndroid.View.ViewGroup?, savedInstanceState: SwiftAndroid.OS.Bundle?) -> SwiftAndroid.View.View {
    ...
    open func onViewCreated(view: SwiftAndroid.View.View, savedInstanceState: SwiftAndroid.OS.Bundle?) {
...
public func AndroidFullScreenDialogFragment_onCreateViewNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let inflater = SwiftAndroid.View.LayoutInflater.init(javaObject: __inflater)
    let container = __container != nil ? SwiftAndroid.View.ViewGroup.init(javaObject: __container) : nil
    let bundle = __savedInstanceState != nil ? SwiftAndroid.OS.Bundle(javaObject: __savedInstanceState) : nil
...
public func AndroidFullScreenDialogFragment_onViewCreatedNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let view = SwiftAndroid.View.View(javaObject: __view)
    let bundle = __savedInstanceState != nil ? SwiftAndroid.OS.Bundle(javaObject: __savedInstanceState) : nil

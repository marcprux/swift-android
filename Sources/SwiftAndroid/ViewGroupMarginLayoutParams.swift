...
open class AndroidViewGroupMarginLayoutParams: SwiftAndroid.View.ViewGroup.LayoutParams {
...
internal extension AndroidViewGroupMarginLayoutParams {
    ...
    struct ViewGroupMarginLayoutParamsJNICache {
        ...
        static let classSignature = SwiftAndroid.View.className(["ViewGroup$MarginLayoutParams"])

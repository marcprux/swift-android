...
open class AndroidTabLayout: AndroidHorizontalScrollView {
    ...
    public override func bindNewJavaObject(context: SwiftAndroid.Content.Context){
    ...
    override open func addView(_ child: SwiftAndroid.View.View, index: Int)  {
    ...
    override open func addView(_ child: SwiftAndroid.View.View, index: Int, params: SwiftAndroid.View.ViewGroup.LayoutParams)  {
    ...
    override open func addView(_ child: SwiftAndroid.View.View, params: SwiftAndroid.View.ViewGroup.LayoutParams)  {

...
public extension SwiftAndroid.Content {
...
public final class AndroidIntent: JavaObject {
    ...
    public convenience init(o: SwiftAndroid.Content.Intent){
        var __locals = [jobject]()
...
public extension SwiftAndroid.Content.Intent {
...
public extension SwiftAndroid.Content.Intent {
     ...
     */
    @discardableResult
    func putExtra(name: String, value: [Int64]) -> SwiftAndroid.Content.Intent {
        ...
        return SwiftAndroid.Content.Intent(javaObject: __return)
    }
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Int8) -> SwiftAndroid.Content.Intent {
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Int) -> SwiftAndroid.Content.Intent {
        var __locals = [jobject]()
     ...
     */
    @discardableResult
    func putExtra(name: String, value: Double) -> SwiftAndroid.Content.Intent {
        var __locals = [jobject]()
     ...
     */
    @discardableResult
    func putExtra(name: String, value: String) -> SwiftAndroid.Content.Intent {
    ...
    @discardableResult
    func setType(_ type: String) -> SwiftAndroid.Content.Intent {
...
private extension SwiftAndroid.Content.Intent {
    // JNI Cache
    struct JNICache {
        
        static let classSignature = SwiftAndroid.Content.className(["Intent"])

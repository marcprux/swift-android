...
public extension AndroidMenuForward {
    ...
    func add(titleRes: Int) -> SwiftAndroid.View.MenuItemForward {
    ...
    func add(_ title: String?) -> SwiftAndroid.View.MenuItemForward {
    ...
    func add(groupId: Int, itemId: Int, order: Int, titleRes: Int) -> SwiftAndroid.View.MenuItemForward {
    ...
    func add(groupId: Int, itemId: Int, order: Int, title: String) -> SwiftAndroid.View.MenuItemForward {
...
internal extension AndroidMenuForward {
    ...
    struct MenuJNICache {
        ...
        static let classSignature = SwiftAndroid.View.className(["Menu"])

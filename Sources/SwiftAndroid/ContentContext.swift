...
open class AndroidContext: JavaObject {
    ...
    public func registerReceiver(receiver: SwiftAndroid.Content.BroadcastReceiver, filter: SwiftAndroid.Content.IntentFilter) -> SwiftAndroid.Content.Intent {
    ...
    public func unregisterReceiver(receiver: SwiftAndroid.Content.BroadcastReceiver){
...
public extension AndroidContext {
    ...
    func systemService <T> (_ service: T.Type) -> T? where T: JavaObject, T: SwiftAndroid.Content.Context.SystemService {
...
internal extension AndroidContext {
    ...
    struct JNICache {
        ...
        static let classSignature = SwiftAndroid.Content.className(["Context"])

...
public extension SwiftAndroid.Widget.CompoundButton {
...
internal extension SwiftAndroid.Widget.CompoundButton {
    
    /// JNI Cache
    struct JNICacheCompoundButton {
        
        /// JNI Java class signature
        static let classSignature = SwiftAndroid.Widget.className(["CompoundButton"])

...
public extension SwiftAndroid.Widget.Button {
...
// MARK: - Private
internal extension SwiftAndroid.Widget.Button {
    
    // JNI cache
    struct JNICacheButton {
        
        // JNI Java class signature
        static let classSignature = SwiftAndroid.Widget.className(["Button"])

...
open class SwiftSupportAppCompatActivity: AndroidContextWrapper {
    ...
    open func onCreate(savedInstanceState: SwiftAndroid.OS.Bundle?) {
    ...
    open func onActivityResult(requestCode: Int, resultCode: Int, data: SwiftAndroid.Content.Intent?) {
    ...
    public func startActivity(intent: SwiftAndroid.Content.Intent){
    ...
    public func startActivityForResult(intent: SwiftAndroid.Content.Intent, requestCode: Int) {
    ...
    public func startService(service: SwiftAndroid.Content.Intent) -> JavaObject? {
    ...
    public func stopService(name: SwiftAndroid.Content.Intent)-> Bool {
    ...
    @inline(__always)
    internal func getResources() -> SwiftAndroid.Content.Res.Resources? {
        
        var __locals = [jobject]()
        
        var __args = [jvalue]( repeating: jvalue(), count: 2)
        
        var result: SwiftAndroid.Content.Res.Resources?
        ...
        withJavaObject {
            ...
            result = __return != nil ? SwiftAndroid.Content.Res.Resources(javaObject: __return) : nil
        }
    ...
    public func setContentView(layout: SwiftAndroid.R.Layout) {
    ...
    public func setContentView(view: SwiftAndroid.View.View) {
    ...
    public func findViewById(_ id: Int) -> SwiftAndroid.View.View? {
    ...
    public func addContentView(_ view: SwiftAndroid.View.View, params: JavaObject) {
...
public func SwiftSupportAppCompatActivity_onCreate( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let bundle = __savedInstanceState != nil ? SwiftAndroid.OS.Bundle(javaObject: __savedInstanceState) : nil
...
public func SwiftSupportAppCompatActivity_onActivityResultNative( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let data = __data != nil ? SwiftAndroid.Content.Intent(javaObject: __data) : nil

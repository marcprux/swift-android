...
open class AndroidWindowManagerLayoutParams: SwiftAndroid.View.ViewGroup.LayoutParams {
...
internal extension AndroidWindowManagerLayoutParams {
    ...
    struct JNICacheWindowManagerLayoutParams {
        ...
        static let classSignature = SwiftAndroid.View.className(["WindowManager$LayoutParams"])

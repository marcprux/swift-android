...
open class AndroidWidgetBaseAdapter: JavaObject {
    ...
    open func notifyDataSetChanged() {
        ...
        withJavaObject {
            ...
            JNIMethod.CallVoidMethod(object: $0,
                                     ...
                                     methodSig: "()V",
                                     methodCache: &SwiftAndroid.Widget.BaseAdapter.JNICache.MethodID.notifyDataSetChanged,
                                     args: &__args,
                                     locals: &__locals)
        }
    }
    ...
    open func getView(position: Int, convertView: SwiftAndroid.View.View?, parent: SwiftAndroid.View.ViewGroup) -> SwiftAndroid.View.View {
...
fileprivate extension SwiftAndroid.Widget.BaseAdapter {
...
private func AndroidWidgetBaseAdapter_getView( _ __env: UnsafeMutablePointer<JNIEnv?>,
    ...
    let convertView = __convertView != nil ? SwiftAndroid.View.View(javaObject: __convertView) : nil
    
    let parentView = SwiftAndroid.View.ViewGroup(javaObject: __parent)

...
public extension SwiftAndroid.Content.Res {
...
public extension AndroidContentResResources {
    ...
    func getDisplayMetrics() -> SwiftAndroid.Util.DisplayMetrics? {
        ...
        return __return != nil ? SwiftAndroid.Util.DisplayMetrics(javaObject: __return) : nil
    }
...
internal extension AndroidContentResResources {
    ...
    struct JNICache {
        ...
        static let classSignature = SwiftAndroid.Content.Res.className(["Resources"])

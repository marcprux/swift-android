...
open class AndroidViewGroup: AndroidView {
    ...
    func bindNewObject(context: SwiftAndroid.Content.Context){
    ...
    open override func dispatchUnhandledMove(focused: SwiftAndroid.View.View, direction: Int) -> Bool {
    ...
    open func addView(_ child: SwiftAndroid.View.View, index: Int)  {
    ...
    open func addView(_ child: SwiftAndroid.View.View, index: Int, params: SwiftAndroid.View.ViewGroup.LayoutParams)  {
    ...
    open func addView(_ child: SwiftAndroid.View.View)  {
    ...
    open func addView(_ child: SwiftAndroid.View.View, params: SwiftAndroid.View.ViewGroup.LayoutParams)  {
    ...
    open func addView(child: SwiftAndroid.View.View, width: Int, height: Int)  {
...
public extension SwiftAndroid.View.ViewGroup {
    ...
    func bringChildToFront(child: SwiftAndroid.View.View)  {
    ...
    func childDrawableStateChanged(child: SwiftAndroid.View.View)  {
    ...
    func childHasTransientStateChanged(child: SwiftAndroid.View.View, childHasTransientState: Bool)  {
    ...
    func clearChildFocus(child: SwiftAndroid.View.View)  {
    ...
    func endViewTransition(view: SwiftAndroid.View.View)  {
    ...
    func findFocus() -> SwiftAndroid.View.View {
    ...
    func focusSearch(focused: SwiftAndroid.View.View, direction: Int) -> SwiftAndroid.View.View {
    ...
    func focusableViewAvailable(v: SwiftAndroid.View.View)  {
    ...
    func getChildAt(index: Int) -> SwiftAndroid.View.View {
     ...
     */
    func measureChild(child: SwiftAndroid.View.View, parentWidthMeasureSpec: Int, parentHeightMeasureSpec: Int)  {
    ...
    func getFocusedChild() -> SwiftAndroid.View.View {
    ...
    func indexOfChild(child: SwiftAndroid.View.View) -> Int {
    ...
    func invalidateChild(child: SwiftAndroid.View.View, dirty: JavaObject)  {
    ...
    func notifySubtreeAccessibilityStateChanged(child: SwiftAndroid.View.View, source: SwiftAndroid.View.View, changeType: Int)  {
    ...
    func offsetDescendantRectToMyCoords(descendant: SwiftAndroid.View.View, rect: JavaObject)  {
    ...
    func offsetRectIntoDescendantCoords(descendant: SwiftAndroid.View.View, rect: JavaObject)  {
    ...
    func onDescendantInvalidated(child: SwiftAndroid.View.View, target: SwiftAndroid.View.View)  {
    ...
    func onNestedFling(target: SwiftAndroid.View.View, velocityX: Float, velocityY: Float, consumed: Bool) -> Bool {
    ...
    func onNestedPreFling(target: SwiftAndroid.View.View, velocityX: Float, velocityY: Float) -> Bool {
    ...
    func onNestedPreScroll(target: SwiftAndroid.View.View, dx: Int, dy: Int, consumed: [Int])  {
    ...
    func onNestedScroll(target: SwiftAndroid.View.View, dxConsumed: Int, dyConsumed: Int, dxUnconsumed: Int, dyUnconsumed: Int)  {
    ...
    func onNestedScrollAccepted(child: SwiftAndroid.View.View, target: SwiftAndroid.View.View, axes: Int)  {
    ...
    func onStartNestedScroll(child: SwiftAndroid.View.View, target: SwiftAndroid.View.View, nestedScrollAxes: Int) -> Bool {
    ...
    func onStopNestedScroll(child: SwiftAndroid.View.View)  {
    ...
    func onViewAdded(child: SwiftAndroid.View.View)  {
    ...
    func onViewRemoved(child: SwiftAndroid.View.View)  {
    ...
    func recomputeViewAttributes(child: SwiftAndroid.View.View)  {
    ...
    func removeView(view: SwiftAndroid.View.View)  {
    ...
    func removeViewInLayout(view: SwiftAndroid.View.View)  {
    ...
    func requestChildFocus(child: SwiftAndroid.View.View, focused: SwiftAndroid.View.View)  {
    ...
    func requestChildRectangleOnScreen(child: SwiftAndroid.View.View, rectangle: JavaObject, immediate: Bool) -> Bool {
    ...
    func requestTransparentRegion(child: SwiftAndroid.View.View)  {
    ...
    func showContextMenuForChild(originalView: SwiftAndroid.View.View, x: Float, y: Float) -> Bool {
    ...
    func showContextMenuForChild(originalView: SwiftAndroid.View.View) -> Bool {
    ...
    func startViewTransition(view: SwiftAndroid.View.View)  {
...
internal extension SwiftAndroid.View.ViewGroup {

...
public struct AndroidManifestPermission {
    ...
    public static let acceptHandover = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCEPT_HANDOVER)
    
    public static let accessCheckinProperties = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_CHECKIN_PROPERTIES)
    
    public static let accessCoarseLocation = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_COARSE_LOCATION)
    
    public static let accessFineLocation = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_FINE_LOCATION)
    
    public static let accessLocationExtraCommands = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_LOCATION_EXTRA_COMMANDS)
    
    public static let accessNetworkState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_NETWORK_STATE)
    
    public static let accessNotificationPolicy = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_NOTIFICATION_POLICY)
    
    public static let accessWifiState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCESS_WIFI_STATE)
    
    public static let accountManager = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ACCOUNT_MANAGER)
    
    public static let addVoicemail = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ADD_VOICEMAIL)
    
    public static let answerPhoneCalls = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.ANSWER_PHONE_CALLS)
    
    public static let batteryStats = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BATTERY_STATS)
    
    public static let bindAccessibilityService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_ACCESSIBILITY_SERVICE)
    
    public static let bindAppwidget = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_APPWIDGET)
    
    public static let bindAutofillService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_AUTOFILL_SERVICE)
    
    public static let bindCarrierServices = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_CARRIER_SERVICES)
    
    public static let bindChooserTargetService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_CHOOSER_TARGET_SERVICE)
    
    public static let bindConditionProviderService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_CONDITION_PROVIDER_SERVICE)
    
    public static let bindDeviceAdmin = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_DEVICE_ADMIN)
    
    public static let bindDreamService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_DREAM_SERVICE)
    
    public static let bindIncallService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_INCALL_SERVICE)
    
    public static let bindInputMethod = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_INPUT_METHOD)
    
    public static let bindMidiDeviceService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_MIDI_DEVICE_SERVICE)
    
    public static let bindNfcService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_NFC_SERVICE)
    
    public static let bindNotificationListenerService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_NOTIFICATION_LISTENER_SERVICE)
    
    public static let bindPrintService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_PRINT_SERVICE)
    
    public static let bindQuickSettingsTile = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_QUICK_SETTINGS_TILE)
    
    public static let bindRemoteviews = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_REMOTEVIEWS)
    
    public static let bindScreeningService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_SCREENING_SERVICE)
    
    public static let bindTelecomConnectionService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_TELECOM_CONNECTION_SERVICE)
    
    public static let bindTextService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_TEXT_SERVICE)
    
    public static let bindTvInput = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_TV_INPUT)
    
    public static let bindVisualVoicemailService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_VISUAL_VOICEMAIL_SERVICE)
    
    public static let bindVoiceInteraction = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_VOICE_INTERACTION)
    
    public static let bindVpnService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_VPN_SERVICE)
    
    public static let bindVrListenerService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_VR_LISTENER_SERVICE)
    
    public static let bindWallpaper = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BIND_WALLPAPER)
    
    public static let bluetooth = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BLUETOOTH)
    
    public static let bluetoothAdmin = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BLUETOOTH_ADMIN)
    
    public static let bluetoothPrivileged = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BLUETOOTH_PRIVILEGED)
    
    public static let bodySensors = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BODY_SENSORS)
    
    public static let broadcastPackageRemoved = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BROADCAST_PACKAGE_REMOVED)
    
    public static let broadcastSms = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BROADCAST_SMS)
    
    public static let broadcastSticky = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BROADCAST_STICKY)
    
    public static let broadcastWapPush = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.BROADCAST_WAP_PUSH)
    
    public static let callPhone = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CALL_PHONE)
    
    public static let callPrivileged = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CALL_PRIVILEGED)
    
    public static let camera = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CAMERA)
    
    public static let captureAudioOutput = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CAPTURE_AUDIO_OUTPUT)
    
    public static let captureSecureVideoOutput = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CAPTURE_SECURE_VIDEO_OUTPUT)
    
    public static let captureVideoOutput = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CAPTURE_VIDEO_OUTPUT)
    
    public static let changeComponentEnabledState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CHANGE_COMPONENT_ENABLED_STATE)
    
    public static let changeConfiguration = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CHANGE_CONFIGURATION)
    
    public static let changeNetworkState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CHANGE_NETWORK_STATE)
    
    public static let changeWifiMulticastState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CHANGE_WIFI_MULTICAST_STATE)
    
    public static let changeWifiState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CHANGE_WIFI_STATE)
    
    public static let clearAppCache = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CLEAR_APP_CACHE)
    
    public static let controlLocationUpdates = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.CONTROL_LOCATION_UPDATES)
    
    public static let deleteCacheFiles = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.DELETE_CACHE_FILES)
    
    public static let deletePackages = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.DELETE_PACKAGES)
    
    public static let diagnostic = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.DIAGNOSTIC)
    
    public static let disableKeyguard = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.DISABLE_KEYGUARD)
    
    public static let dump = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.DUMP)
    
    public static let expandStatusBar = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.EXPAND_STATUS_BAR)
    
    public static let factoryTest = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.FACTORY_TEST)
    
    public static let foregroundService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.FOREGROUND_SERVICE)
    
    public static let getAccounts = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.GET_ACCOUNTS)
    
    public static let getAccountsPrivileged = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.GET_ACCOUNTS_PRIVILEGED)
    
    public static let getPackageSize = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.GET_PACKAGE_SIZE)
    
    public static let globalSearch = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.GLOBAL_SEARCH)
    
    public static let installLocationProvider = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.INSTALL_LOCATION_PROVIDER)
    
    public static let installPackages = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.INSTALL_PACKAGES)
    
    public static let installShortcut = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.INSTALL_SHORTCUT)
    
    public static let instantAppForegroundService = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.INSTANT_APP_FOREGROUND_SERVICE)
    
    public static let internet = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.INTERNET)
    
    public static let killBackgroundProcesses = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.KILL_BACKGROUND_PROCESSES)
    
    public static let locationHardware = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.LOCATION_HARDWARE)
    
    public static let manageDocuments = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MANAGE_DOCUMENTS)
    
    public static let manageOwnCalls = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MANAGE_OWN_CALLS)
    
    public static let masterClear = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MASTER_CLEAR)
    
    public static let mediaContentControl = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MEDIA_CONTENT_CONTROL)
    
    public static let modifyAudioSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MODIFY_AUDIO_SETTINGS)
    
    public static let modifyPhoneState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MODIFY_PHONE_STATE)
    
    public static let mountFormatFilesystems = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MOUNT_FORMAT_FILESYSTEMS)
    
    public static let mountUnmountFilesystems = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.MOUNT_UNMOUNT_FILESYSTEMS)
    
    public static let nfc = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.NFC)
    
    public static let nfcTransactionEvent = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.NFC_TRANSACTION_EVENT)
    
    public static let packageUsageStats = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.PACKAGE_USAGE_STATS)
    
    public static let processOutgoingCalls = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.PROCESS_OUTGOING_CALLS)
    
    public static let readCalendar = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_CALENDAR)
    
    public static let readCallLog = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_CALL_LOG)
    
    public static let readContacts = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_CONTACTS)
    
    public static let readExternalStorage = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_EXTERNAL_STORAGE)
    
    public static let readFrameBuffer = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_FRAME_BUFFER)
    
    public static let readLogs = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_LOGS)
    
    public static let readPhoneNumbers = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_PHONE_NUMBERS)
    
    public static let readPhoneState = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_PHONE_STATE)
    
    public static let readSms = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_SMS)
    
    public static let readSyncSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_SYNC_SETTINGS)
    
    public static let readSyncStats = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_SYNC_STATS)
    
    public static let readVoicemail = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.READ_VOICEMAIL)
    
    public static let reboot = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REBOOT)
    
    public static let receiveBootCompleted = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.RECEIVE_BOOT_COMPLETED)
    
    public static let receiveMms = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.RECEIVE_MMS)
    
    public static let receiveSms = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.RECEIVE_SMS)
    
    public static let receiveWapPush = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.RECEIVE_WAP_PUSH)
    
    public static let recordAudio = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.RECORD_AUDIO)
    
    public static let reorderTasks = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REORDER_TASKS)
    
    public static let requestCompanionRunInBackground = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REQUEST_COMPANION_RUN_IN_BACKGROUND)
    
    public static let requestCompanionUseDataInBackground = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REQUEST_COMPANION_USE_DATA_IN_BACKGROUND)
    
    public static let requestDeletePackages = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REQUEST_DELETE_PACKAGES)
    
    public static let requestIgnoreBatteryOptimizations = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS)
    
    public static let requestInstallPackages = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.REQUEST_INSTALL_PACKAGES)
    
    public static let sendRespondViaMessage = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SEND_RESPOND_VIA_MESSAGE)
    
    public static let sendSms = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SEND_SMS)
    
    public static let setAlarm = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_ALARM)
    
    public static let setAlwaysFinish = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_ALWAYS_FINISH)
    
    public static let setAnimationScale = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_ANIMATION_SCALE)
    
    public static let setDebugApp = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_DEBUG_APP)
    
    public static let setProcessLimit = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_PROCESS_LIMIT)
    
    public static let setTime = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_TIME)
    
    public static let setTimeZone = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_TIME_ZONE)
    
    public static let setWallpaper = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_WALLPAPER)
    
    public static let setWallpaperHints = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SET_WALLPAPER_HINTS)
    
    public static let signalPersistentProcesses = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SIGNAL_PERSISTENT_PROCESSES)
    
    public static let statusBar = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.STATUS_BAR)
    
    public static let systemAlertWindow = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.SYSTEM_ALERT_WINDOW)
    
    public static let transmitIr = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.TRANSMIT_IR)
    
    public static let uninstallShortcut = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.UNINSTALL_SHORTCUT)
    
    public static let updateDeviceStats = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.UPDATE_DEVICE_STATS)
    
    public static let useBiometric = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.USE_BIOMETRIC)
    
    public static let useSip = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.USE_SIP)
    
    public static let vibrate = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.VIBRATE)
    
    public static let wakeLock = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WAKE_LOCK)
    
    public static let writeApnSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_APN_SETTINGS)
    
    public static let writeCalendar = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_CALENDAR)
    
    public static let writeCallLog = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_CALL_LOG)
    
    public static let writeContacts = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_CONTACTS)
    
    public static let writeExternalStorage = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_EXTERNAL_STORAGE)
    
    public static let writeGservices = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_GSERVICES)
    
    public static let writeSecureSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_SECURE_SETTINGS)
    
    public static let writeSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_SETTINGS)
    
    public static let writeSyncSettings = SwiftAndroid.ManifestPermission(rawValue:
        AndroidManifestPermissionConstants.WRITE_SYNC_SETTINGS)
    
    public static let writeVoicemail = SwiftAndroid.ManifestPermission(rawValue:

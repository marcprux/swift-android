...
public struct AndroidManifestPermissionGroup {
    ...
    public static let calendar = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CALENDAR)
    
    public static let callLog = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CALL_LOG)
    
    public static let camera = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CAMERA)
    
    public static let contacts = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.CONTACTS)
    
    public static let location = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.LOCATION)
    
    public static let microphone = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.MICROPHONE)
    
    public static let phone = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.PHONE)
    
    public static let sensors = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.SENSORS)
    
    public static let sms = SwiftAndroid.ManifestPermissionGroup(rawValue:
        AndroidManifestPermissionGroupConstants.SMS)
    
    public static let storage = SwiftAndroid.ManifestPermissionGroup(rawValue:

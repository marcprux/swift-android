...
open class AndroidLinearLayoutLayoutParams: SwiftAndroid.View.ViewGroup.MarginLayoutParams {
    ...
    // Copy constructor.
    public convenience init(p: SwiftAndroid.View.ViewGroup.LayoutParams){
...
internal extension AndroidLinearLayoutLayoutParams {
    ...
    struct LayoutParamsJNICache {
        ...
        static let classSignature = SwiftAndroid.Widget.className(["LinearLayout$LayoutParams"])

...
public extension SwiftAndroid.OS {
...
public final class AndroidOsParcelUuid: JavaObject {
    ...
    public class func fromString( arg0: String ) -> SwiftAndroid.OS.ParcelUuid? {
        ...
        return __return != nil ? SwiftAndroid.OS.ParcelUuid( javaObject: __return ) : nil
    }
...
private extension SwiftAndroid.OS.ParcelUuid {
